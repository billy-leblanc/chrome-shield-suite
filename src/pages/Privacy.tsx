  ...
  return (
    <div style={{ minHeight: "100vh", background: "#060C1A", color: "#E2E8F0", fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, sans-serif' }}>
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "72px 24px 96px" }}>
        ...
        <p style={{ fontSize: 13, color: "#334155", marginBottom: 56 }}>Last updated: June 15, 2026</p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 48 }}>
          ...
          <section>
            ...
            <p style={p}>
              When you initiate a payment on PayPal or Wells Fargo Zelle, the memo text is sent to our Cloudflare relay and then to Anthropic's API (Claude) for fraud analysis. It is analyzed in transit and <strong style={{ color: "#CBD5E1" }}>not stored</strong>. We keep only the result of the analysis — a risk score, the fraud techniques detected, the platform, and an amount <em>range</em> (e.g. "medium") — never the memo text and never the exact amount.
            </p>

            <h3 style={h3}>Gmail email content</h3>
            <p style={p}>
              When you open an email in Gmail, Safety Intercept reads the subject and a portion of the body and sends it to our relay and Anthropic for analysis. This content is analyzed in transit and <strong style={{ color: "#CBD5E1" }}>not stored</strong>. If the score is low, nothing happens. If the score is high, a warning is shown and a detection event is logged — see below.
            </p>

            <h3 style={h3}>Detection events</h3>
            <p style={p}>
              When a fraud risk is detected, we log an event to our Cloudflare infrastructure. It contains: the platform, risk level, the fraud-technique tags triggered, an amount range, a timestamp, a random install identifier (see below), and — for email — the <em>sender's</em> domain and address. It does <strong style={{ color: "#CBD5E1" }}>not</strong> contain your message text, the email subject or body, the message ID, your exact payment amount, or your IP address.
            </p>

            <h3 style={h3}>Approximate location</h3>
            <p style={p}>
              We derive only your <strong style={{ color: "#CBD5E1" }}>country</strong> from your network connection, at the Cloudflare edge, for basic analytics. Your raw IP address is never stored, and we do not collect city, region, or precise location.
            </p>
            ...
            <p style={p}>
              If the extension flags something you know is safe, you can tap <strong style={{ color: "#CBD5E1" }}>"Not a scam."</strong> By default that sends only the sender and which signals misfired — no content. We then ask whether you'd like to <strong style={{ color: "#CBD5E1" }}>share that email's subject and text</strong> to help us stop flagging messages like it. The content is sent only if you explicitly tap "Share," only for that one message, and is stored separately for the sole purpose of improving detection. Nothing is shared unless you choose it.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={p}>
              Memo text and email content sent for analysis is processed by Anthropic's Claude API and is governed by their <a href="https://www.anthropic.com/privacy" target="_blank" rel="noreferrer" style={{ color: "#38BDF8", textDecoration: "none" }}>privacy policy</a>. We do not send Anthropic any identifying information about you — only the text to be analyzed.
            </p>

            <h3 style={h3}>Cloudflare</h3>
            <p style={p}>
              Our relay and storage run on Cloudflare Workers and Cloudflare KV. Detection events and (if you choose to share them) correction contributions are stored in Cloudflare's infrastructure, governed by their <a href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noreferrer" style={{ color: "#38BDF8", textDecoration: "none" }}>privacy policy</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <ul style={ul}>
              ...
              <li style={li}><strong style={{ color: "#CBD5E1" }}>Decline sharing:</strong> Content is shared only when you actively tap "Share" on a correction. You never have to.</li>
